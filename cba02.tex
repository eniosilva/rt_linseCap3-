...
\end{figure}
A Fig. \ref{tree} apresenta diferentes níveis de clusterização, contendo duas ou três subclasses, detalhes da classificação proposta é apresentada na Tabela TAl. Após o processo de clusterização as classificação fonéticas tornam-se mais discriminativa e, consequentemente, mais apropriada para a etapa de treinamento.
...
\begin{table}[htb]
  ...
  \begin{center}
    \begin{tabular}{|c|c|l|}\hline
      ...
      $Cl_1$ (ex. $/z/$ )&$/z/$ & Fricativas vozeadas alveolares\\\hline
...
Assim como em TAL, os atributos investigados são:
\subsection{tal}
\subsection{tal}
\subsection{tal}
\subsection{tal}
