...
\section{Introdução}
A convergência da computação e comunicação produziu uma sociedade que se abastece de informações. No entanto, a maioria das informações está em sua forma bruta, ou seja, de dados. Se estes se caracterizam como fatos registrados, então, pode-se considerar que a informação é o conjunto de padrões, ou expectativas, que fundamentam os dados. Todavia, há uma enorme quantidade de informações que são potencialmente importantes, mas não possuem banco de dados.
