...
\subsection{Extração de Atributos}\label{selAtrib}
...
\begin{table}[htb]
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|}\hline
      Class.& Qtd. atributos &Taxa de Acerto\\\hline\hline
      BGP & 67 & 100\%\\                       
      BGP & 67 & 100\%\\
      BGP & 67 & 100\%\\
      BGP & 67 & 100\%\\
...
O \textit{framework} de classificação, composto pelos atributos e classificadores descritos na Tabela TAL, é examinado através da comparação de sua matriz de confusão fonética com a matriz obtida pelo sistema padrão de classficação direta. As matrizes são apresentadas na Fig. TAL. Nesse contexto, nota-se uma menor confusão na matriz resultante do \textit{framework} aqui proposto, confirmando, assim, sua eficácia.
