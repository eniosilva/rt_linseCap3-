...
Desde modo, objetivando a seleção de atributos para o desenvolvimento de um classificador que clusterize sianis de banda limitada em classes fricativas, neste trabalho a estratégia proposta tem como base os algoritmos de árvore de decisão e \textit{principal component analysis} (PCA) seguido do descarte de componentes de menor importância. Assim, a estratégia proposta consiste em identificar os parâmetros que facilitam a distinção entre classes fonéticas diferentes. Os resultados das simulações permitem inferir acerca da seleção dos melhores parâmetros a serem usados na composição de um classificador fonético e a eficácia da estratégia proposta é comprovada através dos os resultados obtidos que atestam que o algoritmo proposto exibe melhores atributos característicos.

%confirmam a eficácia da estratégia proposta.
