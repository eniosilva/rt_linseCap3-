...
\begin{itemize}
 \item A taxa de cruzamento por zero
  \begin{equation}
   ...
   % \end{array}
  \end{equation}
onde $Sinal[s(k)]=1$, quando $s(k) \geq 0$; e $Sinal[s(k)]=-1$, quando $s(k) \leq 0$.
