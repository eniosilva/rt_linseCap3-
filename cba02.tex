...
\title{Clusterização Em Classes Fonéticas de Sinais de Fala de Banda Limitada}
...
Assim, objetivando a seleção de atributos para o desenvolvimento de um classificador que clusterize sinais de banda limitada em classes fricativas, neste trabalho a estratégia proposta tem como base os algoritmos de árvore de decisão e \textit{principal component analysis} (PCA) seguido do descarte de componentes de menor importância \cite{Webb2002}. Dessa forma, a estratégia proposta consiste em identificar os atributos que facilitam a distinção entre classes fonéticas diferentes. Os resultados das simulações permitem inferir acerca da seleção dos melhores atributos a serem usados na composição de um classificador fonético e comprovam a eficácia da estratégia proposta.
